...
public class RRItems {
    public static final ItemSubRegistryHelper ITEMS = ReverseReverse.REGISTRY_HELPER.getItemSubHelper();

    public static final DeferredItem<RetroSneakersItem> RETRO_SNEAKERS;

    static {
        RETRO_SNEAKERS = ITEMS.createItem("retro_sneakers", () -> new RetroSneakersItem(RRArmorMaterials.RETRO, ArmorItem.Type.BOOTS,
                (new Item.Properties()).durability(84)));
    }
